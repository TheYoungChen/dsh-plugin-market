	...
	factory: (require) => {
		...
		*/
		...
		async function fetchLatestVersion(fullName) {
			try {
				const response = await fetch(`https://api.github.com/repos/${fullName}/contents/package.json`, { headers: { Accept: "application/vnd.github+json" } });
				...
				foreground !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("code", {
								style: commandStyle,
								children: ["pnpm add ", foreground.source]
							}),
