	...
	factory: (require) => {
		...
		*/
		...
		function InstalledManager({ t }) {
			...
			const refresh = (force) => {
				fetchInstalled(force).then(setReport, () => {});
			};
			(0, react.useEffect)(() => {
				refresh(false);
			}, []);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("h3", {
						style: sectionStyle,
						children: [
							t("manager.systemSection"),
							" (",
							systemBundles.length,
							")"
						]
					}),
					systemBundles.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						style: emptyStyle,
						children: t("manager.emptySystem")
					}) : null,
					systemBundles.map((bundle) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: rowStyle,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							style: rowNameStyle,
							children: bundle
